...
clusterProfiler (Rajput et al., 2008).
...
signalling, and cell migration, producing a broader disruption of gene
expression than MZ1 alone (Guo, Zheng and Peng, 2023) (Tee et al., 2014).
...
## Discussion
My reanalysis found results broadly inline with those of Mori et al. (2024).
PDD alone induced minimal transcriptional changes, while MZ1 alone produced
substantial differential expression (2,397 genes), supporting its ability to
degrade BRD4. Both combination treatments produced significantly more
differentially expressed genes than MZ1 alone, supporting the original 
...
pathways related to chromatin remodelling were consistently enriched across
MZ1-containing conditions (Tee et al., 2014). Additionally, MAPK pathways
were also enriched in some conditions consistent with known BRD4 regulation
of MAPK signalling and chromatin remodelling (Guo, Zheng and Peng, 2023).
